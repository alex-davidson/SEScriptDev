...
namespace IngameScript
{
    public static class Hydrogen
    {
        public class SummaryByGrid : IDisplayPart
        {
            ...
            {
                IMyGasTank tank;
                return TryGetHydrogenTank(block, out tank);
            }

            private bool TryGetHydrogenTank(IMyTerminalBlock block, out IMyGasTank tank)
            {
            ...
            {
                IMyGasTank tank;
                if (!TryGetHydrogenTank(block, out tank)) return;
